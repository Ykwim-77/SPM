...
INSERT INTO "new_StockTransaction" ("createdAt", "healthUnitId", "id", "medicineDetails", "medicineId", "medicineName", "quantity", "type", "userId") SELECT "createdAt", "healthUnitId", "id", "medicineDetails", "medicineId", "medicineName", "quantity", "type", "userId" FROM "StockTransaction";

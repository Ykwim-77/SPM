  ...
  return (
    <SafeAreaView style={styles.wrap} edges={['top']}>
      <View style={styles.header}>
        <AccessiblePressable onPress={() => router.back()} style={styles.back} testID="med-new-back" label="Voltar">
      ...
      <View style={styles.body}>
        <Text style={styles.message}>O cadastro de medicamentos não está disponível no app móvel.</Text>
        <Text style={styles.subtext}>Use a aplicação web para registrar medicamentos.</Text>
      </View>
    </SafeAreaView>
  );
}
